...
public class UserConfig extends WebSecurityConfigurerAdapter {
	...
	//WebSecurityConfigurerAdapter got deprecated after version 5.7
    // developer
    // devops
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
        		csrf().disable() //It is not required to be used in prod env.
        		//using csrf enables us to use POST, PUT, DELETE requests as well.
        		//without csrf only GET request will work
                .httpBasic()
                .and()
